...
{
        public class AAAMinute : DynamicData
        {
            ...
            {
                string filePath = $"D:\\develop\\cSharpProjects\\LEAN\\Lean\\Data\\custom\\{config.Symbol.Value}_Minute.csv";
